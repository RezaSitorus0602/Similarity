...
</style></head><body style="background-image: url('<?php echo base_url() ;?>asetadmin/gambar/jadi1.jpg')">

<form action="<?php echo base_url(); ?>Dataskripsi/login_validation" method="POST">
<h2><?php  
